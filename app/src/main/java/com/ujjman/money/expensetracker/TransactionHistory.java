...
public class TransactionHistory extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        searchTextview=findViewById(R.id.search_transactionhistory_textview);
        recyclerView.setLayoutManager(new LinearLayoutManager(this));
        list = new ArrayList<>();
        fullScreencall();
        DatabaseReference rootRef = FirebaseDatabase.getInstance("https://expense-tracker-a6ae5-default-rtdb.asia-southeast1.firebasedatabase.app").getReference().child("transactionHistory");
        ValueEventListener eventListener = new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                adapter = new PaymentListAdapter(TransactionHistory.this, list);
                recyclerView.setAdapter(adapter);
                adapter.notifyDataSetChanged();
                findViewById(R.id.loadingPanel_transactionHistory).setVisibility(View.GONE);
            }
